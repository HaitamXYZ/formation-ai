...
export async function POST(request: Request, context: Context) {
  try {
    ...
    const resource = await backendRequest<TrainingModuleResource>(`/api/trainings/${id}/modules/${moduleId}/resources/upload`, { method: "POST", headers: createBearerHeaders(token), body: await request.formData() });
